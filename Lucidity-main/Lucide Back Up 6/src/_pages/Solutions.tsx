  ...
  <div className="space-y-2">
    ...
    {isLoading ? (
      <div className="mt-4 flex">
                      ...
                      Extraction de l'énoncé du problème...
                    </p>
      </div>
    ) : (
    ...
    {isLoading ? (
      ...
      <div className="space-y-1">
        <div className="flex items-start gap-2 text-[13px] leading-[1.4] text-gray-100">
          ...
          <div>
            <strong>Temps:</strong> {timeComplexity}
          </div>
        </div>
        <div className="flex items-start gap-2 text-[13px] leading-[1.4] text-gray-100">
          <div className="w-1 h-1 rounded-full bg-blue-400/80 mt-2 shrink-0" />
          <div>
            <strong>Espace:</strong> {spaceComplexity}
          </div>
        </div>
      </div>
    )}
  ...
  useEffect(() => {
    ...
    const cleanupFunctions = [
      ...
      window.electronAPI.onSolutionError((error: string) => {
        showToast(
          "Échec du traitement",
          "Une erreur s'est produite lors du traitement de vos captures supplémentaires.",
          "error"
        )
      ...
      window.electronAPI.onDebugError(() => {
        showToast(
          "Échec du traitement",
          "Une erreur s'est produite lors du débogage de votre code.",
          "error"
        )
        setDebugProcessing(false)
      }),
      window.electronAPI.onProcessingNoScreenshots(() => {
        showToast(
          "Aucune capture",
          "Il n'y a aucune capture supplémentaire à traiter.",
          "neutral"
        )
      })
    ]
            ...
            <div className="rounded-lg overflow-hidden">
              <div className="px-4 py-3 space-y-4 max-w-full">
                ...
                {problemStatementData?.validation_type === "manual" ? (
                  <ContentSection
                    title={problemStatementData?.output_format?.subtype === "voice" ? "Résultat audio" : "Résultat capture"}
                  ...
                  <>
                    ...
                    <ContentSection
                      title={problemStatementData?.output_format?.subtype === "voice" ? "Entrée vocale" : "Énoncé du problème"}
                      content={problemStatementData?.problem_statement}
                    ...
                    {solutionData && (
                      <>
                        ...
                        />
                        <SolutionSection
                          title={problemStatementData?.output_format?.subtype === "voice" ? "Réponse" : "Solution"}
